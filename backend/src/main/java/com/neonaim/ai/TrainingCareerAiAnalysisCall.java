...
@Entity
@Table(name = "training_career_ai_analysis_calls")
class TrainingCareerAiAnalysisCall {
	...
	@Column(name = "anchor_session_id", nullable = false)
	private UUID anchorSessionId;
	...
	@Column(name = "comparable_sample_size", nullable = false)
	private int comparableSampleSize;

	@Column(name = "configuration_count", nullable = false)
	...
	protected TrainingCareerAiAnalysisCall() {
	}

	TrainingCareerAiAnalysisCall(UUID userId, UUID anchorSessionId, String trainingId,
			String sourceId, String dataVersion, String providerId, String modelName,
			String promptVersion, String confidence, int sampleSize, int comparableSampleSize,
			int configurationCount, Instant createdAt) {
		this.id = UUID.randomUUID();
		this.userId = userId;
		this.anchorSessionId = anchorSessionId;
		...
		this.comparableSampleSize = comparableSampleSize;
		this.configurationCount = configurationCount;
		this.createdAt = createdAt;
	}

	void complete(TrainingAnalysisProvider.TokenUsage usage, boolean wasCacheHit,
			String serializedResult, Instant completed) {
		status = Status.READY;
	...
	String confidence() { return confidence; }
	int sampleSize() { return sampleSize; }
	int comparableSampleSize() { return comparableSampleSize; }
	int configurationCount() { return configurationCount; }
